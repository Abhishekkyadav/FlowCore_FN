...
export default function WorkflowStep() {
  ...
  return (
    <div className="p-6 bg-slate-100 min-h-screen font-sans text-slate-700">
      <div className="bg-white rounded-2xl shadow-md overflow-hidden">
        {/* Header */}
        <div className="px-6 py-5 border-b border-gray-200">
          <h2 className="m-0 text-[30px] leading-tight font-semibold text-[#1E293B] tracking-tight">
            Workflow Step
          </h2>
        ...
        <div className="px-6 py-5 border-b border-gray-200 bg-gray-50">
          <div className="flex justify-between items-center flex-wrap gap-3">
            <input
              ...
              className="w-[300px] px-4 py-2.5 border border-gray-300 rounded-lg text-[13px] text-slate-600 focus:outline-none"
            />
          ...
          <table className="w-full border-collapse">
            ...
            <tbody>
              {workflowSteps.map((item) => (
                ...
                >
                  <td className="px-4 py-3 border-b border-gray-200 text-[13px] text-[#334155] font-bold">
                    {item.workflowStepId}
                  </td>
